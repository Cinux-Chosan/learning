# [Redux and React: An Introduction](http://jakesidsmith.com/blog/post/2017-11-18-redux-and-react-an-introduction/) 【已校验】
...
既然你已经对 action 和 reducer 有了基本的认识，那么我们就可以将它用以实践，先来创建一个 store。
